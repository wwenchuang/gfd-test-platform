...
let generateModalReturnWorkflow = '';
...
let lastSonicMigratable = 0;
let taskAppModuleAssignmentMode = false;
let taskAppModuleAssignmentPackage = '';
...
let executionModuleFilter = '';
const EXECUTION_RERUN_PAGE_SIZE = 20;
let executionRerunFilters = { query: '', failureType: 'all', page: 1 };
...
let agentHistorySelection = new Set();
...
const AUTO_AGENT_STEPS = [
  'IDLE','PREPARE_SOURCE','PLAN','IMPACT_ANALYSIS','CASE_RETRIEVAL','MATCH_CASES',
