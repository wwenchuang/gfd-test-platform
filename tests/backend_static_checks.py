...
def main():
    ...
    require("def _agent_generate_yaml_from_mindmap_pipeline" in agent_service_source and "generate_mindmap_from_request" in agent_service_source and '"split_by_case"' in agent_service_source and "mindmap_pipeline" in agent_service_source, "Agent new-requirement YAML generation must reuse the existing mindmap/Figma/case pipeline before fallback")
