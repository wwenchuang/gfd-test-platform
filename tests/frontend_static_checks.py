...
def main():
    ...
    require(
        'data-workflow="api_regression"' in html and 'title="基线接口测试"' in html,
        "API automation sidebar must expose baseline API testing as the release regression entry",
    )
    require(
    ...
    require("execution.logicalFailedCount" in html and "修复后通过" in html, "Agent final report must let logical recovery override stale raw failed attempts")
    ...
    require("js/execution.js?v=20260701-install-refresh" in html and "js/app.js?v=20260727-runner-active-task" in html and "js/state.js?v=20260729-apifox-discovery" in html and "js/api.js?v=20260731-api-product-workbench" in html and "js/navigation.js?v=20260731-api-product-workbench" in html and "js/agent-workbench.js?v=20260729-agent-report-progress" in html and "css/app.css?v=20260731-api-product-workbench" in html and "css/round5.css?v=20260801-api-baseline-runner-v1" in html and "js/api-testing.js?v=20260801-api-baseline-runner-v1" in html and "js/agent-status.js?v=20260731-agent-failure-buckets" in html, "Frontend cache versions must include Apifox discovery, API baselines, API login auth, live API reports, API run history, API case form editor, Apifox environment snapshots, native API execution, API environment readiness, simplified API workbench scope recovery, API report/environment editing, API live execution logs, saved Apifox source shelf, native API automation center navigation, Agent report-card readable final score/full timestamp, API sidebar polish, productized API workbench, reusable Apifox credentials, command-center API UI, AI API Testing Studio UI, sidebar icons, instant local workbench snapshot rendering, local API environment debugging, API command-center dashboard, reference-style API runner board, one-click baseline API release regression, and prior workflow updates")
