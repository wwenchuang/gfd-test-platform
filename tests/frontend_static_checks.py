...
def main():
    ...
    require("GENERATED_SMOKE_RERUN_DEFAULT_LIMIT = 8" in html and "generatedSmokeTargets" in html and "generatedSmokeRerunLimit(summary" in html and "重跑首批冒烟" in html and "重跑全部冒烟" in html and "run_all" in html, "Generated smoke rerun must default to dynamic 3/5/8 first batches and require an explicit all-smoke action")
    ...
    require("js/execution.js?v=20260701-install-refresh" in html and "js/app.js?v=20260701-smoke-dynamic" in html and "js/agent-workbench.js?v=20260701-smoke-dynamic" in html, "Frontend cache version must be bumped for install refresh and smoke rerun updates")
