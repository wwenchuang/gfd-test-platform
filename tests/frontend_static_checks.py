...
def main():
    ...
    require("js/execution.js?v=20260701-install-refresh" in html and "js/app.js?v=20260701-install-refresh" in html, "Install refresh fix must bump task-manager cache version")
