...
def main():
    ...
    require("js/execution.js?v=20260701-install-refresh" in html and "js/app.js?v=20260701-smoke-dynamic" in html and "js/agent-workbench.js?v=20260714-agent-phases" in html and "js/agent-status.js?v=20260702-agent-artifacts" in html, "Frontend cache version must be bumped for install refresh, smoke rerun, Agent phases, and artifact updates")
