...
def main():
    ...
    require("js/execution.js?v=20260701-device-label" in html and "js/app.js?v=20260701-device-label" in html, "Device label fix must bump task-manager cache version")
