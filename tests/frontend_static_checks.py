...
def main():
    ...
    require("js/execution.js?v=20260701-install-refresh" in html and "js/app.js?v=20260701-smoke-dynamic" in html and "js/state.js?v=20260714-agent-observability" in html and "js/agent-workbench.js?v=20260714-rerun-causality" in html and "css/app.css?v=20260714-agent-results" in html and "css/round5.css?v=20260714-agent-observability" in html and "js/agent-status.js?v=20260702-agent-artifacts" in html, "Frontend cache version must be bumped for install refresh, smoke rerun, Agent phases, artifacts, and result semantics")
