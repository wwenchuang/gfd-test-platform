...
def main():
    ...
    require("nonSmokeAttempted" in html and "explicitRemaining" in html and "result.nonSmokePassed" in html, "Agent history cards must prefer backend non-smoke buckets instead of deriving remaining from inflated smoke phases")
