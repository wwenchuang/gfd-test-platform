...
def main():
    ...
    require("js/utils.js?v=20260808-runtime-cleanup" in html and "js/execution.js?v=20260701-install-refresh" in html and "js/app.js?v=20260727-runner-active-task" in html and "js/state.js?v=20260808-runtime-cleanup" in html and "js/navigation.js?v=20260808-runtime-cleanup" in html and "js/agent-workbench.js?v=20260803-agent-final-report-counts" in html and "css/app.css?v=20260808-runtime-cleanup" in html and "css/round5.css?v=20260808-runtime-cleanup" in html and "js/agent-status.js?v=20260808-runtime-cleanup" in html, "Frontend cache versions must include the active frontend modules")
