...
def main():
    ...
    require('agent-status.js?v=20260828-full-platform-ux-20260902-a108-workflow-clarity' in html, "agent status must publish the A108 application editor fixes")
    require('app.js?v=20260831-identity-20260902-a108-workflow-clarity' in html, "app.js must publish the A108 generation feedback fixes")
    ...
    require("继续下一批可执行" in html and "执行全部可执行" in html and "remaining_executable" in html, "Generated executable rerun must support small-batch continuation and explicit full execution")
