...
def main():
    ...
    require(
        ...
        and "选择业务" in api_testing_js
        and "同步接口" in api_testing_js
        and "生成用例" in api_testing_js
        and "审阅确认" in api_testing_js
        and "执行报告" in api_testing_js,
        "Every API page must expose one human-readable daily workflow and next action",
    )
    require(
    ...
    require(
        ...
        and "生成 AI 用例" in api_testing_js,
    ...
    require("reportSummary" in html and "agentRunResultMeta" in html and "agentRunResultSummaryHtml" in html and "查看报告" in html and "openAgentRunReport" in html, "Agent history cards must show final report results and link directly to the report tab")
    require("nonSmokeAttempted" in html and "nonSmokePlanned" in html and "已计划，未进入扩展执行" in html and "bucketAttempted" in html and "rawPassed" in html, "Agent history cards must separate planned non-smoke YAML from actually executed non-smoke results and avoid impossible passed/total ratios")
    ...
    require("js/execution.js?v=20260701-install-refresh" in html and "js/app.js?v=20260727-runner-active-task" in html and "js/state.js?v=20260729-apifox-discovery" in html and "js/api.js?v=20260729-api-baselines" in html and "js/navigation.js?v=20260729-api-baselines" in html and "js/agent-workbench.js?v=20260729-agent-report-progress" in html and "css/app.css?v=20260730-agent-history-report-card" in html and "css/round5.css?v=20260731-api-live-log-sources" in html and "js/api-testing.js?v=20260731-api-live-log-sources" in html and "js/agent-status.js?v=20260731-agent-history-final-buckets" in html, "Frontend cache versions must include Apifox discovery, API baselines, API login auth, live API reports, API run history, API case form editor, Apifox environment snapshots, native API execution, API environment readiness, simplified API workbench scope recovery, API report/environment editing, API live execution logs, saved Apifox source shelf, Agent report-card final non-smoke buckets, and prior workflow updates")
