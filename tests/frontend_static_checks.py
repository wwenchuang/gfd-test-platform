...
def main():
    ...
    require("js/execution.js?v=20260701-install-refresh" in html and "js/app.js?v=20260727-runner-active-task" in html and "js/state.js?v=20260729-apifox-discovery" in html and "js/navigation.js?v=20260804-api-single-panel-v1" in html and "js/agent-workbench.js?v=20260803-agent-final-report-counts" in html and "css/app.css?v=20260731-api-product-workbench" in html and "css/round5.css?v=20260804-api-single-panel-v1" in html and "js/agent-status.js?v=20260804-api-single-panel-v1" in html, "Frontend cache versions must include the active frontend modules")
