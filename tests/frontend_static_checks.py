...
def main():
    ...
    require('agent-status.js?v=20260828-full-platform-ux-20260902-a107-agent-terminal' in html, "agent status must publish the A107 terminal presentation fixes")
    require('app.js?v=20260831-identity-20260902-a107-agent-terminal' in html, "app.js must publish the A107 rerun confirmation fixes")
