...
def main():
    ...
    require("captureAgentTimelineViewState" in html and "restoreAgentTimelineViewState" in html and "agentTimelineDetailToggled" in html, "Agent timeline technical logs must preserve open state and scroll during polling refresh")
