...
def main():
    ...
    require("nonSmokeAttempted" in html and "nonSmokePlanned" in html and "已计划，未进入扩展执行" in html, "Agent history cards must separate planned non-smoke YAML from actually executed non-smoke results")
