...
def main():
    ...
    require("js/execution.js?v=20260701-install-refresh" in html and "js/app.js?v=20260701-smoke-adjust" in html and "js/agent-workbench.js?v=20260701-smoke-rerun" in html, "Frontend cache version must be bumped for install refresh and smoke rerun updates")
