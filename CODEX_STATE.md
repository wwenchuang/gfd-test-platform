...
线上产品版本为`1aac3f31ec67b34204f655fa0a126033ac065b88`，PyYAML可用。已从Apifox默认模块v11的1031个接口中建立9条当前版本核心链路基线：家用稳定6条、共享稳定2条、DeepSeek CAD按需1条。新数据没有覆盖或移动旧291条活动基线；当前活动基线共300条（家用290、共享10），原每日08:00家用283加共享8的调度保持不变。
