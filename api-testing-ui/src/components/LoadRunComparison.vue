...
function condition(value:unknown):string{return value==null || value===''?'未记录 / 未核验':typeof value==='object'?JSON.stringify(value):String(value)}
