...
const emit = defineEmits<{ back: []; edit: [result: ExecutionCaseResult, execution: ExecutionView]; rerunFailed: [execution: ExecutionView]; rerunCase: [result: ExecutionCaseResult, execution: ExecutionView]; loadEvidence: [result: ExecutionCaseResult] }>()
