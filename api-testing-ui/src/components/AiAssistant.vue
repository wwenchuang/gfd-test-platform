...
const props = withDefaults(defineProps<{ selectedCount: number; job: AiJob | null; error?: string; polling?: boolean; canResume?: boolean }>(), {
  error: '', polling: false, canResume: false,
})
