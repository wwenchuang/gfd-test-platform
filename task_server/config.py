...
MINDMAP_VISUAL_BATCH_SIZE = max(1, env_int("MIDSCENE_MINDMAP_VISUAL_BATCH_SIZE", min(8, AI_VISION_IMAGE_LIMIT)))
MINDMAP_VISUAL_TIMEOUT_SECONDS = max(30, env_int("MIDSCENE_MINDMAP_VISUAL_TIMEOUT_SECONDS", 120))
MINDMAP_VISUAL_TOTAL_BUDGET_SECONDS = max(
    MINDMAP_VISUAL_TIMEOUT_SECONDS,
    env_int("MIDSCENE_MINDMAP_VISUAL_TOTAL_BUDGET_SECONDS", 300)
)
YAML_VISUAL_BATCH_SIZE = max(1, env_int("MIDSCENE_YAML_VISUAL_BATCH_SIZE", MINDMAP_VISUAL_BATCH_SIZE))
...
YAML_VISUAL_TOTAL_BUDGET_SECONDS = max(
    ...
    env_int("MIDSCENE_YAML_VISUAL_TOTAL_BUDGET_SECONDS", 5400)
)
...
AGENT_RUN_STEPS = [
    "IDLE", "PLAN", "PREPARE_SOURCE", "IMPACT_ANALYSIS", "CASE_RETRIEVAL",
