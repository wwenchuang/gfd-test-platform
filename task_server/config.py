...
TASK_RELEASE_REVISION = os.getenv("TASK_RELEASE_REVISION", "").strip()
...
MAX_CONCURRENT_LARGE_REQUESTS = max(1, env_int("TASK_MAX_CONCURRENT_LARGE_REQUESTS", 2))
LARGE_REQUEST_THRESHOLD = max(1024 * 1024, env_int("TASK_LARGE_REQUEST_THRESHOLD", 8 * 1024 * 1024))
BACKGROUND_JOB_WORKERS = max(1, env_int("TASK_BACKGROUND_WORKERS", 2))
BACKGROUND_JOB_QUEUE_SIZE = max(1, env_int("TASK_BACKGROUND_QUEUE_SIZE", 8))
