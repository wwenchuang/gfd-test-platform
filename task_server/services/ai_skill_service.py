    ...
    if "百度网盘" in point:
        ...
        if "文档打印" in feature_text:
            return [
                ...
                "如果当前不在首页，点击底部「首页」回到首页",
                "在首页文档导入入口区域找到「本地导入」「相册导入」「微信导入」这一行",
                "向右翻看首页文档导入入口列表一次，查找位于「本地导入」之后的「百度网盘」入口",
                "等待「百度网盘」入口稳定显示",
                "点击「百度网盘」入口",
                "等待百度网盘授权、登录或文件选择页面打开",
            ], [
                "文档打印首页的百度网盘入口可见，点击后进入百度网盘授权、登录或文件选择流程"
            ]
        if "普通照片" in feature_text:
            return [
                ...
                "等待进入「5寸照片」或普通照片打印页面，页面展示「相册导入」「微信导入」「相机拍照」等导入方式",
                "等待「百度网盘」入口稳定显示",
                "点击「百度网盘」入口",
                "等待百度网盘授权、登录或文件选择页面打开",
            ], [
                "普通照片打印页面展示百度网盘入口，点击后进入百度网盘授权、登录或文件选择流程"
            ]
        if "证件照" in feature_text:
            return [
                ...
                "如果当前不在首页，点击底部「首页」回到首页",
                "进入「证件照」或「一寸照」入口",
                "等待进入「一寸照」或证件照编辑页面，页面展示照片上传区域和导入方式",
                "等待底部或导入方式区域出现「百度网盘」入口",
                "点击「百度网盘」入口",
                "等待百度网盘授权、登录或文件选择页面打开",
            ], [
                f"{feature}页面展示百度网盘入口，点击后进入百度网盘授权、登录或文件选择流程"
            ]
        if "照片拼版" in feature_text:
            return [
                ...
                "照片拼版导入页面展示百度网盘入口，点击后进入百度网盘授权、登录或文件选择流程"
            ]
        if "扫描复印" in feature_text:
            return [
                ...
                "扫描复印首页展示百度网盘入口，点击后进入百度网盘授权、登录或文件选择流程"
            ]
        return [
            "启动 App，并等待首页显示「小白扫描王」或底部导航「首页」",
            "如果当前不在首页，点击底部「首页」回到首页",
